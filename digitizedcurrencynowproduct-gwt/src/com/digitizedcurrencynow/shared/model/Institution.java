...
public class Institution implements Serializable{
	...
	public String toString() {
		return "Institution [institutionId=" + institutionId + ", instType="  + instType + ", instName1=" + instName1 + ", instName2="
				+ instName2 + ", instFiscalYear=" + instFiscalYear 	+ ", instPrimeLang=" + instPrimeLang
				+ ", instEffectiveFromDate=" + instEffectiveFromDate  + ", instEffectiveToDate=" + instEffectiveToDate 	+ ", instCurrentFlag=" + instCurrentFlag + "]";
	}
